...
function renderPokemon(pokeData){
    ...
    var linkText = document.createTextNode("MORE INFO");
     ...
     // link.title = "INFO";
    link.href = `https://en.wikipedia.org/wiki/${pokeData.name}`;
    ...
    pokeContainer.append(pokeName, pokeNumber, link , pokeTypes);//appending all details to the pokeContainer div
